...
const INSTRUCTIONS_CONTENT = [
  ...
  // ── LiveEvent ──
  ['═══ LIVEEVENT TAB ═══', ''],
  ['Optional — schedule a live takeover of the gym display: a YouTube Live stream OR any web page (e.g. live race results).', ''],
  ['When a live event is active, the display switches to that stream or page fullscreen. Normal rotation resumes automatically when the event ends.', ''],
  ['', ''],
  ['Column', 'Description'],
  ['Title', 'Event display name. Shows briefly as an overlay on the live stream. Example: "CrossFit Games 2026 Finals".'],
  ['URL', 'A YouTube Live/video URL (youtube.com/watch?v=, youtu.be/, youtube.com/live/) plays in the video player. ANY other URL is shown as a fullscreen web page, e.g. "https://my.raceresult.com/423702/#0_530E94". A site that forbids embedding will show its own error instead.'],
  ...
  ['', ''],
  ['Behavior:', ''],
  ['  Takeover:', '  When a live event is active (current time between Start and End), the display immediately switches to the stream or page, fullscreen.'],
